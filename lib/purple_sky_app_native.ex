defmodule PurpleSkyAppNative do
  @moduledoc """
  ...
  This can be used in your application as:
      ...
      use PurpleSkyAppNative, :live_view
  ...
  import PurpleSkyAppWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {PurpleSkyAppWeb.Layouts.SwiftUI, :app}
        ],
  ...
  defp helpers(format) do
    gettext_quoted =
      quote do
        import PurpleSkyAppWeb.Gettext
      end
    ...
    core_component_module = Module.concat([PurpleSkyAppWeb, CoreComponents, plugin.module_suffix])
